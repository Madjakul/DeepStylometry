...
class SOAP(optim.Optimizer):
    ...
    def merge_dims(self, grad, max_precond_dim):
        """Merges dimensions of the gradient tensor till the product of the
        dimensions is less than or equal to max_precond_dim."""
    ...
    def update_preconditioner(
        ...
        """Updates the preconditioner matrices and the eigenbases (L, R, Q_L,
        Q_R in the paper)."""
    ...
    def get_orthogonal_matrix_QR(self, state, max_precond_dim=10000, merge_dims=False):
        """Computes the eigenbases of the preconditioner using one round of
        power iteration followed by torch.linalg.qr decomposition."""
