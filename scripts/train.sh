...
PROCESSED_DS_DIR=$SCRATCH/Datasets/deep-stylometry/answerdotai-modernbert-base/no-padding/ # $WORK_DIR/Datasets/deep-stylometry/answerdotai-modernbert-base/no-padding/
