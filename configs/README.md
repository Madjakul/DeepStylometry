...
mode: "train" # do not modify
project_name: "deep-stylometry"
group_name: "test-styleembedding-512-se-default"
do_train: false
do_test: true
...
data:
  ...
  batch_size: 32
  tokenizer_name: "AnnaWegmann/Style-Embedding"
  max_length: 512
  map_batch_size: 1000
...
model:
  base_model_name: "AnnaWegmann/Style-Embedding"
  is_decoder_model: false
  add_linear_layers: false
  dropout: 0.3
...
Test configuration for triplet loss
...
mode: "train"
project_name: "deep-stylometry"
group_name: "train-deepstylometry-512-se-infonce"
do_train: true
do_test: false
...
train:
  ...
  num_cycles: 0.5
  # --- checkpointing
  checkpoint_metric: "val_mrr" # only if a checkpoint directory was provided
  checkpoint_mode: "max"
  save_top_k: 4
  # --- trainer ---
  device: "gpu"
